...
let intervalId = null;
const SolveMurder = ({ setNavStatus, levelUp, setGameon, gameOn }) => {
  const { completed } = useSelector((state) => state.auth);
          ...
          <div>
            ...
            <p>
              <ol>
                ...
                <li>
                  You have to type the name of the killer in the input box.
                </li>
                <li>You will get only 2 attempts to guess the killer.</li>
                <li>
                  In case you answer wrong on both attempts, you will not get
                  the points for the final round.
                </li>
